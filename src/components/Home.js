            ...
            <Row className="show-grid">
              ...
              <Col xs={12} sm={6} md={6} className="content-col">
                <MtSvgLines animate={ true } duration={ 1400 }>
                  ...
                  <div id="mobile-img">
                    <svg width="281px" height="399px" viewBox="0 0 281 399">
                        <title>mobile</title>
                        ...
                        <g id="Welcome" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            <g id="mobile">
                                ...
                                <g id="base" transform="translate(41.000000, 50.000000)">
                                ...
                                <g id="line-code" transform="translate(53.000000, 29.000000)" stroke-linecap="square">
                                    <path class="pathtest" d="M69.525,1.5 L110.488459,1.5" id="Line-2" stroke="#FFFFFF" stroke-width="3"></path>
